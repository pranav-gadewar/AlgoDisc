...
function CLOOK() {
  ...
  // Function to calculate the CLOOK scheduling algorithm
  const calculateCLOOK = () => {
    ...
    // Sort the queue in ascending order for CLOOK
  ...
  return (
    <div className="clook-container p-8">
      <div className="intro-section mb-8">
        <h1 className="text-4xl font-bold text-center text-purple-600 mb-4">CLOOK (Circular LOOK) Disk Scheduling Algorithm</h1>
